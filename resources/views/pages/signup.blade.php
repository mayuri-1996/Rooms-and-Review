				...
				<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
					<div class="modal-content" id="sign-up">
						...
						<div class="modal-body">
							<h4 class="modal-header-title">Sign Up</h2>
							...
							<div class="text-center">
								<p class="mt-5"><i class="ti-user mr-1"></i>Already Have An Account? <a href="{{route('pages.signin')}}" class="link">Go For LogIn</a></p>
							</div>
						</div>
					</div>
				</div>
